...
export class MyMovable {

	constructor(myPhysicsWorld, yPos=0) {
		this.myPhysicsWorld = myPhysicsWorld;
		this.yPos = yPos;
		this.convexRigidBody = undefined;
	}

	create(setCollisionMask=true, geometryType=1, position = {x: 0, y: 0 + this.yPos, z: 0}, mass=0, size=5) {
		...
		// AMMO:
		let shape = commons.createConvexHullShape(vertices);
