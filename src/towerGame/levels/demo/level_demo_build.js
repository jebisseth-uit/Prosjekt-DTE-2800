...
export async function level_demo_build(scene_width, scene_length){
	...
	await createWall_no_windows("wall_front", scene_width, scene_length, scene_width*0.01, {x:0, y:scene_width/2, z:scene_width/2}, {x:0, z:0, y:0}, 0.15)
